...
export function AuthProvider({ children }) {
  ...
  const signIn = async (email, password) => {
    try {
      ...
      return { error: error.response?.data || { detail: 'Invalid credentials' }, data: null };
    }
  };
  ...
  return (
    <AuthContext.Provider value={{ user, profile, loading, signIn, signUp, signOut, accessToken }}>
      {children}
