...
import { Bell, Building2, ClipboardList, LayoutDashboard, LogOut, Shield, UsersRound } from 'lucide-react';
...
const navItems = [
  ...
  { label: 'Permission Matrix', path: '/admin/permissions', icon: Shield },
...
export default function AdminLayout({ title, children }) {
  ...
  const name = profile?.name || profile?.email?.split('@')[0] || 'Admin User';
